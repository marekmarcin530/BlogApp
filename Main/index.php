    ...
    <div class="container p-5 text-white text-center bg">
      <div class="row">
        ...
        <div class="col-sm-6">
          ...
          <h5>Sprawdź pogodę w Twoim mieście!</h5>
          <form method="POST">
          ...
          if(isset($_POST['submit'])) {
              ...
              $odczuwalna = $danetemp->main->feels_like;

              $wiatr = $danetemp->wind->speed;

              $ikona = $danetemp->weather[0]->icon;
              $ikona_pogody = "https://openweathermap.org/img/wn/$ikona.png";

              echo "<img src='http://openweathermap.org/img/w/$ikona.png' alt='Weather icon'>";
              echo "<br /><p>Temperatura w $miasto wynosi: $temperatura &#8451;<br /> 
              Temperatura odczuwalna: $odczuwalna &#8451;<br />Prędkość wiatru: $wiatr</p><br />";
