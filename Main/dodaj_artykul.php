...
<html lang="en">
  ...
  <a class="navbar-brand me-auto" href="index.php">Strona główna</a>
    ...
    <div class="container mt-3">
      <div class="row">
        ...
        <form method="POST" action="articles.php" enctype="multipart/form-data">
          <p class="fs-2">Dodaj artykuł</p>

            <label for="title" class="fs-4">Tytuł</label><br />
            <textarea class="form-control" rows="1" id="tlt" name="tlt"></textarea><br />

            <label for="atricle" class="fs-4">Treść</label><br />
            <textarea class="form-control" rows="7" id="article" name="article"></textarea>

            <input type="file" class="mt-2" name="fileToUpload" id="fileToUpload">

            <input type="submit" name="dodaj" value="Dodaj" class="btn btn-secondary me-auto mt-1"/>
        </form>
        </div>
